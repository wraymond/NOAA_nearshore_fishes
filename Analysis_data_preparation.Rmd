...
## Spatial ##
seines <- readOGR(dsn="E:/wraymond2/My Documents/Graduate School/GIS General", layer="NOAA_SEAK_seines")
NO_SEAK <- readOGR(dsn="E:/wraymond2/My Documents/Graduate School/GIS General", layer="NO_SEAK")
NI_SEAK <- readOGR(dsn="E:/wraymond2/My Documents/Graduate School/GIS General", layer="NI_SEAK")
SO_SEAK <- readOGR(dsn="E:/wraymond2/My Documents/Graduate School/GIS General", layer="SO_SEAK")
SI_SEAK <- readOGR(dsn="E:/wraymond2/My Documents/Graduate School/GIS General", layer="SI_SEAK")
```
...
fish.all$ForkLength_cm <- fish.all$ForkLength / 10 # Conver mm to cm
...
```{r}
event <- unique(fish.event)
write.csv(event, "Data/NOAA_SEAK_EventID.csv", row.names = FALSE)
```


```{r region assign}
test <- point.in.poly(seines, NO_SEAK)
