...
## Export
The file is pretty massive so we will pare it down.
```{r reduce}
names(fish.all)

fish <- cbind(fish.all[,c(2:6, 13, 16, 17, 21, 23, 26, 27, 1, 37:40, 34, 44)])
```


```{r export}
write.csv(fish, "Data/NOAA_All_Data_allL_mass.csv", row.names = FALSE)
```
