...
First we need to calculate the total fish catch at each site and plot. I will plot raw and 4th root transformed data.
```{r event sums}
## EventID sums ##
